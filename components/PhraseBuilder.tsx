  ...
  return (
    <div className="bg-surface-dark/50 p-4 sm:p-6 rounded-2xl shadow-lg animate-fadeIn flex flex-col gap-4 h-full">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-text-light dark:text-text-dark">Construtor de Frases</h2>
        <button
      ...
      {/* Sentence as Text */}
      <div className="w-full bg-background-dark shadow-inner rounded-lg p-3 min-h-[48px] flex items-center text-lg text-text-dark">
